...
extern "C"
{
    ...
    COYOTE_API int next_boolean(void* scheduler)
    {
        Scheduler* ptr = (Scheduler*)scheduler;
        return (int)ptr->next_boolean();
    }
    ...
    COYOTE_API int scheduled_operation_id(void* scheduler)
    {
        Scheduler* ptr = (Scheduler*)scheduler;
        return (int)ptr->scheduled_operation_id();
    }

    COYOTE_API uint64_t random_seed(void* scheduler)
    {
        Scheduler* ptr = (Scheduler*)scheduler;
